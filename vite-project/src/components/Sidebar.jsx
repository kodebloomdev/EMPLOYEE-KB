...
const Sidebar = ({
  ...
  const Item = ({ icon: Icon, label, active }) => (
    <a href="#" className={itemClass(active)}>
  ...
  return (
    <div
      className={`fixed top-16 left-0 bottom-0 z-50 overflow-y-auto bg-white shadow-[2px_0_10px_rgba(0,0,0,0.05)]
    ...
    >
      ...
      <button
        ...
        className="mt-2 w-full flex justify-end px-5 py-4 text-gray-500 hover:text-gray-700 transition"
